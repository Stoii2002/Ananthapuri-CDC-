...
SECRET_KEY = "django-insecure-&3(edgat_)nvb-0culsd$v48^^kglgscevwr_9)i2ehxyol)3k"
...
JAZZMIN_SETTINGS = {
    ...
    # Logo to use for your site, must be present in static files, used fo   r brand on top left
    # "site_logo": "img/logocdc.png",

    # Logo to use for your site, must be present in static files, used for login form logo (defaults to site_logo)
    "login_logo":"img/logocdc.png",
    ...
    "site_icon": "img/logocdc.png",

    # Welcome text on the login screen
    "welcome_sign": "Welcome to the Ananthapuri CDC",

    # Copyright on the footer
    "copyright": "miscarchive",
