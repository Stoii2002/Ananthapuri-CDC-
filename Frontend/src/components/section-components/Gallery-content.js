...
class Gallery_content extends Component {
    ...
    return <div className="overflow-hidden space">
    <div className="container">
        ...
        <div className="row gy-30 gallery-row filter-active overlay-direction">
            ...
            <div className="col-md-6 col-xl-auto filter-item gallery-card_wrapp">
                <div className="gallery-card style2" data-theme-color="#7DBE48">
                    <a className="box-img popup-image" href="assets/img/gallery/gallery_3_5.jpg"><img src="assets/img/gallery/gallery_3_5.jpg" alt="gallery image"/>
                        <div className="box-content">
                            <span className="icon-btn style2">
                                <i className="fas fa-eye"></i></span>
                        </div>
            ...
            <div className="col-md-6 col-xl-auto filter-item gallery-card_wrapp">
                <div className="gallery-card style2" data-theme-color="#FFCD4D">
                    <a className="box-img popup-image" href="assets/img/gallery/gallery_3_6.jpg"><img src="assets/img/gallery/gallery_3_6.jpg" alt="gallery image"/>
                        <div className="box-content">
                            <span className="icon-btn style2">
                                <i className="fas fa-eye"></i></span>
                        </div>
            ...
            <div className="col-md-6 col-xl-auto filter-item gallery-card_wrapp">
                <div className="gallery-card style2" data-theme-color="#FE5A86">
                    <a className="box-img popup-image" href="assets/img/gallery/gallery_3_7.jpg"><img src="assets/img/gallery/gallery_3_7.jpg" alt="gallery image"/>
                        <div className="box-content">
                            <span className="icon-btn style2">
                                <i className="fas fa-eye"></i></span>
                        </div>
            ...
            <div className="col-md-6 col-xl-auto filter-item gallery-card_wrapp">
                <div className="gallery-card style2" data-theme-color="#FC800A">
                    <a className="box-img popup-image" href="assets/img/gallery/gallery_3_8.jpg"><img src="assets/img/gallery/gallery_3_8.jpg" alt="gallery image"/>
                        <div className="box-content">
                            <span className="icon-btn style2">
                                <i className="fas fa-eye"></i></span>
                        </div>
            ...
            <div className="col-md-6 col-xl-auto filter-item gallery-card_wrapp">
                <div className="gallery-card style2" data-theme-color="#16C4E3">
                    <a className="box-img popup-image" href="assets/img/gallery/gallery_3_9.jpg"><img src="assets/img/gallery/gallery_3_9.jpg" alt="gallery image"/>
                        <div className="box-content">
                            <span className="icon-btn style2">
                                <i className="fas fa-eye"></i></span>
                        </div>
