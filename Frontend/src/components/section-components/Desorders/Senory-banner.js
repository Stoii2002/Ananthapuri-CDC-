...
const Senory_banner = () => {
    ...
    return (
        <div className="breadcumb-wrapper " data-bg-src="assets/img/bg/sensory_banner-img-1.jpg">
                <div className="banner-shape" data-bg-src="assets/img/shape/banner_bg_2.png"></div>
                <div className="container">
                    <div className="breadcumb-content">
                        <h1 className="breadcumb-title">Sensory Processing Disorders</h1>
